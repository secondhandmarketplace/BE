...
CREATE TABLE university (
    university_id   BIGINT NOT NULL PRIMARY KEY,    -- 대학교 고유 식별자
...
CREATE TABLE user (
    user_id           BIGINT NOT NULL PRIMARY KEY,  -- 사용자 고유 식별자
...
CREATE TABLE category (
    category_id         BIGINT NOT NULL PRIMARY KEY,  -- 카테고리 고유 식별자
...
CREATE TABLE product (
    product_id               BIGINT NOT NULL PRIMARY KEY,  -- 상품 고유 식별자
...
CREATE TABLE productImage (
    image_id      BIGINT NOT NULL PRIMARY KEY,  -- 이미지 고유 식별자
...
CREATE TABLE chatroom (
    chatroom_id         BIGINT NOT NULL PRIMARY KEY,  -- 채팅방 고유 식별자
...
CREATE TABLE chatmessage (
    chatmessage_id  BIGINT NOT NULL PRIMARY KEY,  -- 메시지 고유 식별자
...
CREATE TABLE useractivitylog (
    log_id        BIGINT NOT NULL PRIMARY KEY,  -- 로그 고유 식별자
...
CREATE TABLE transaction (
    transaction_id   BIGINT NOT NULL PRIMARY KEY,  -- 거래 고유 식별자
    product_id       BIGINT NOT NULL,              -- 상품 ID
...
CREATE TABLE review (
    review_id      BIGINT NOT NULL PRIMARY KEY,  -- 리뷰 고유 식별자
